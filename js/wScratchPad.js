...
(function($)
{
	...
	{
		width		: 640,						// set width - best to match image width
		height		: 940,						// set height - best to match image height
	...
	ScratchPad.prototype = 
	{
		...
		setBgImage: function()
		{
			if(this.settings.image)
			{
                //this.sp.append('<img src='+this.settings.image+'  />')
				this.sp.css({
		...
		drawImage: function(imagePath)
		{
            ...
            var _hhh =$(window).height();
  			img.src = imagePath;
  			$(img).load(function(){
  				$this.ctx.drawImage(img, 0, 0, _www, _hhh);
  				$this.setBgImage();
  			})
		},
